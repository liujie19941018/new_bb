...
$(function () {
    ...
    layui.use(['form', 'layer', 'element', 'laydate', 'table', 'echarts'], function () {
        ...
        var obj = {
            type: 'get'
            , url: "LayuiCMSluyun/services/data/todoList.json"
...
function renderTodayUserTable(chartId) {
    var obj = {
        ...
        , page: { theme: '#1E9FFF' }
        , height: 480
        , url: "LayuiCMSluyun/services/data/todayUserTable.json"
        , where: {
            batchNumber: chartId
        }
        , cols: [[
...
function pieChartLoad() {
    ...
    var obj = {
        type: 'get'
        , url: "LayuiCMSluyun/services/data/todayQuery.json?date=" + todayDate
        , contentType: 'application/json'
        , data: '{}'
        , dataType: 'json'
        , success: function (result) {
